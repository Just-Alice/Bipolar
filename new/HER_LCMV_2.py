...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 22 11:47:28 2026
...
for n in all_rest:
    ...
    block = 'b1'
    sample_dir = op.join('/Volumes/KINGSTON/MEG_Data_PhD/',subject)
    ...
    subjects_dir = '/Volumes/KINGSTON/subjects/'
    ...
    for ll in mylabel_names:
        aparc_label_name = ll
        label = mne.read_labels_from_annot(subject=subject_fs, parc='aparc',
