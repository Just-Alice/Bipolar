...
all = [17 18 19 20 27 35 36 40 42 44 46 51 52 56 57 59 64 69 70 2 4 6 8 10 12 14 16 22 23 24 28 29 31 32 38 45 47 53 54 55 67 58 61 63 65 68];
...
dataHERnorm_bipolar_tpeaks = {}; % without 10 31 54 55 67
...
for ss = all
    ...
    dataHERnorm_bipolar_tpeaks{ss} = dataHERnorm; % cell structure, 26 labels x trials x samples
...
% filetag_1 = ['dataHERnorm_bipolar_tpeaks.mat'];
% save(filetag_1, 'dataHERnorm_bipolar_tpeaks')

%%


% % Step 1: Identify empty cells
% emptyCells = cellfun(@isempty, dataHERnorm_bipolar_tpeaks);
% 
% % Step 2: Filter out empty cells
% dataHERnorm_bipolar_tpeaks = dataHERnorm_bipolar_tpeaks(~emptyCells);
% 
% 
% alltogether = cat(2, dataHERnorm_bipolar_tpeaks{:});
...
% title('HER bipolar mOFC tpeaks');
% xlim([-0.2 0.6])
% xlabel('Time');
% ylabel('Amplitude');
% % saveas(gcf, 'HER_bipolar_mOFC_tpeaks.png', 'png');
% 
% 
% %  close all