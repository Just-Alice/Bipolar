...
bad_subj = [10 31 54 55 67];

length(all_subj)

for ss = all_subj
    % table for R
    clear subject group trial_num
    ...
    load(filetag) %, 'dataHER_tpeaks', 'time_HER_ms'
    ...
    if ss == 10
        bad_epochs = [245, 246, 302];
    elseif ss == 31
        bad_epochs = [1, 251];
    elseif ss == 54
        bad_epochs = [189:197, 488:498];
    elseif ss == 55
        bad_epochs = [217, 218, 219];
    elseif ss == 67
        bad_epochs = [214, 215, 226, 227];
    end
    ...
    if ss == 31 || ss == 58
        ...
        trial_ind_help = zeros(160, 1);
        alltrials = cat(1, trial_ind_help, alltrials);
        alltrials1 = cat(1, trial_ind_help, alltrials1);
    end
...
cd /Users/marinaivanova/Documents/Our_project/Heart/all_HER/timeanalysis/
