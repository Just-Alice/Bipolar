...
for i = 1: length(healthy)
    ...
    fpath = ['/Volumes/KINGSTON/MEG_Data_PhD/', subj, '/HER/'];
    ...
    newdataHER = mean(dataHER_LCMV, 2, 'omitnan');
    % newdataHER = newdataHER(:,:,xp1:xp2);
    newdataHER = squeeze(mean(newdataHER(9:10, :, :), 1))'
...
cd '/Users/marinaivanova/Documents/Our_project/Heart/all_HER/'
...
saveas(gcf, 'p_value_mOFC_fake', 'png');

filetag = ['p_value_mOFC_fake.mat'];
