...
load(filetag)
 ...
 plot(time,x)
 title(['Heartbeat evoked response mOFC LCMV and eLoreta zhanx ',num2str(ss)]) % final plot
 xlabel('Time')
 ylabel('Amplitude')
 % Ensure no variable named 'xlim' is in the workspace
 if exist('xlim', 'var')
...
load(filetag)
 ...
 plot(time,x)
 title(['Heartbeat evoked response cACC LCMV and eLoreta zhanx ',num2str(ss)]) % final plot
 xlabel('Time')
 ylabel('Amplitude')
 % Ensure no variable named 'xlim' is in the workspace
 if exist('xlim', 'var')
...
load(filetag)
 ...
 plot(time,x)
 title(['Heartbeat evoked response rACC LCMV and eLoreta zhanx ',num2str(ss)]) % final plot
 xlabel('Time')
 ylabel('Amplitude')
 % Ensure no variable named 'xlim' is in the workspace
 if exist('xlim', 'var')
